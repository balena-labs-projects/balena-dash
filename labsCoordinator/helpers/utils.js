...
module.exports.SetVariable = (variableName, value) => {
  // let command = `curl -s --header "Content-Type:application/json" "$BALENA_SUPERVISOR_ADDRESS/v5/device_config_variable($BALENA_DEVICE_UUID)?apikey=$BALENA_SUPERVISOR_API_KEY" --data '{"value": "${value}"}'`
  // execSync(command)
