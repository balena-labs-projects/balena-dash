...
* Add photo count [Daniel Andrade]
* Add scheduler and wifi-connect back to docker-compose [Daniel Andrade]
* Add delay before starting gallery [Daniel Andrade]
* Add scheduler and wifi-connect back to docker-compose [Daniel Andrade]
* Removed balena-cli from package.json [Daniel Andrade]
* Remove VIM and reduce size [Daniel Andrade]
